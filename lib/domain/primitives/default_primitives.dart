...
import 'easa_multi_pilot_time.dart';
...
/// implementation.
///
/// Grows by one line per primitive as later issues land — never by a change
/// to [JurisdictionProjection], which only ever sees this through the
...
final PrimitiveRegistry defaultPrimitives = PrimitiveRegistry(
  ...
  multiPilotTimeRules: {'easa.multi_pilot_time': easaMultiPilotTime},
);
